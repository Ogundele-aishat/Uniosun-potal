...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const slipView = document.ga// CORE ADMISSION ARCHITECTURE CONTROLLER
document.addEventListener('DOMContentLoaded', () => {
    // Core Dom Bindings
    const viewPortalBtn = document.getElementById('view-portal-btn');
    const viewAdminBtn = document.getElementById('view-admin-btn');
    ...
    // Render OLevel Subjects Dropdowns Matrix
    ...
    // SAFE ROUTING ENGINE: Swaps standard display containers without tampering with your header layout
    ...
    // Verification Logic (Start Application)
    ...
    // Clean Professional Slip Layout
...
});etElementById('slip-view-container');
    const adminView = document.getElementById('admin-view-container');
